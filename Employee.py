...
class Employee(object):
    '''Write the constructor below. It should take in five arguments:
       ...
       are required.'''
    def __init__(self, first, laste, title, hpw, hr):
        self.__first_name = first #Double underscore after 'self.' makes it private
    ...
    def set_Hourly_Rate(self, newHourly):
        self.hourly_rate = newHourly
        #No return for setter method
    ...
    def get_total_compensation(self):
        return totalHours * 50 * self.hours_per_week
...
class Manager(object):
    ...
    def __init__(self, first, laste, title, hpw, hr, bp):
        super().__init__(self, first, laste, title, hpw, hr)
        try:
    ...
    def get_total_compensation(self):
        return super().get_total_compensation() * ((100 + self.bonus_percent)/(100))
